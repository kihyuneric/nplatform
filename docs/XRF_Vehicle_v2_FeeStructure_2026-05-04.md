...
### 3.1 XRF Foundation 보수 — tier 별 변동

| 항목 | BASE ★ | CONSERVATIVE | SAVE-THE-DEAL |
|------|--------|--------------|---------------|
| Carry (8% Hurdle 초과분) | **15%** | 10% | 5% |
| 관리보수 (%/yr) | **0.7%** | 0.5% | 0.5% |
| Setup (1회) | **0.5%** | 0.3% | 0.3% |

### 3.2 엔플랫폼 보수 — tier 별 변동 (v2)

| 항목 | BASE ★ | CONSERVATIVE | SAVE-THE-DEAL |
|------|--------|--------------|---------------|
| AI Valuation | 0.3%/yr | 0.3%/yr | 0.2%/yr |
| Pipeline Sourcing | 1.3%/yr | 1.3%/yr | 1.0%/yr |
| PM | 0.5%/yr | 0.5%/yr | 0.5%/yr |
| KR Margin | 0.4%/yr | 0.4%/yr | 0.3%/yr |
| **엔플랫폼 합계** | **2.5%/yr** | **2.5%/yr** | **2.0%/yr** |
...
| Metric | v2 (현재) | v1 (이전 참고) |
|--------|-----------|----------------|
| Pool 총액 | $717,969 | $725,355 |
| LP capital | **$717,969** | $652,819 |
| 대부업체 capital | $0 | $72,535 |
| LP 1인당 | **$7,180** | $6,528 |
| 엔플랫폼 합계 Fee | $33,231 (2.5%) | $39,877 (3.0%) |
| LP Net Profit | $299,262 | $292,352 |
| LP Net Profit/LP | $2,993 | $2,924 |
| **LP ROI** | **41.68%** | 44.78% |
| LP IRR | 25.92%/yr | 27.85%/yr |

### v2 3-tier 비교 (Jongno)

| Tier | 엔플랫폼 합계 Fee | XRF Carry | LP ROI |
|------|-------------------|-----------|--------|
| BASE ★ | $33,231 (2.5%/yr) | 15% | 41.68% |
| CONSERVATIVE | $33,231 (2.5%/yr) | 10% | 44.40% |
| SAVE-THE-DEAL | $26,584 (2.0%/yr) | 5% | 47.52% |

> Jongno BASE LP ROI 41.68% ≥ 20% → AUTO 판정 **BASE** (양보 불필요).
