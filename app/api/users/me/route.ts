...
export async function GET() {
  ...
  if (error) {
    // Fall back to mock on DB error (e.g. table not yet migrated)
    console.error('[users/me] DB error:', error.message)
    return NextResponse.json({ ...MOCK_USER, id: userId, _mock: true })
  }
