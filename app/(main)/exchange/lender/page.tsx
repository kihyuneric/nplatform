...
const C = {
  ...
  amber: "var(--color-warning)", amber2: "#051C2C", purple: "#051C2C", rose: "var(--color-danger)", teal: "#051C2C",
...
const HIGHLIGHT_STYLES: Record<string, { bg: string; color: string; border: string }> = {
  인기:     { bg: "rgba(165, 63, 138,.12)",   color: C.rose,   border: "rgba(165, 63, 138,.25)" },
  추천:     { bg: "rgba(5, 28, 44,.12)",  color: C.em,     border: "rgba(5, 28, 44,.25)" },
  프리미엄: { bg: "rgba(5, 28, 44,.12)",  color: C.amber,  border: "rgba(5, 28, 44,.25)" },
  신규:     { bg: "rgba(5, 28, 44,.12)",  color: C.blue,   border: "rgba(5, 28, 44,.25)" },
};
    ...
    <div style={{ background: C.l1, minHeight: "100vh" }}>
      ...
      <section ref={heroRef} className="relative overflow-hidden" style={{ backgroundColor: C.bg1 }}>
        <div className="pointer-events-none absolute inset-0"
          style={{
            backgroundImage: `radial-gradient(ellipse 80% 60% at 50% -10%, rgba(5, 28, 44,.20) 0%, transparent 70%)`,
          }}
        />
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-0 pt-14 lg:px-8">
          ...
          >
            <div className="mb-4 inline-flex items-center gap-2 rounded-full px-3 py-1 text-[11px] font-semibold uppercase tracking-widest"
              style={{ background: "rgba(5, 28, 44,.12)", color: C.blueL, border: `1px solid rgba(5, 28, 44,.25)` }}>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="mb-10 text-center">
            <div className="mb-3 inline-flex items-center gap-2 rounded-full px-3 py-1 text-[11px] font-bold uppercase tracking-widest"
              style={{ background: "rgba(5, 28, 44,.1)", color: C.em, border: `1px solid rgba(5, 28, 44,.2)` }}>
          ...
          <div className="grid items-start gap-8 lg:grid-cols-2">
            ...
            <div className="space-y-4">
              ...
              {/* AI Recommendation */}
              <div className="rounded-2xl p-4" style={{ background: "rgba(5, 28, 44,.06)", border: `1px solid rgba(5, 28, 44,.2)` }}>
                <div className="flex gap-3">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl"
                    style={{ background: "rgba(5, 28, 44,.15)" }}>
          ...
          <div className="rounded-2xl overflow-hidden" style={{ border: `1px solid ${C.l3}` }}>
            <div className="px-8 py-10" style={{ backgroundColor: C.bg2 }}>
              <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl"
                style={{ background: "rgba(5, 28, 44,.15)", border: `1px solid rgba(5, 28, 44,.25)` }}>
