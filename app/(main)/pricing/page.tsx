 ...
 *   2. 거래 수수료 — 매각사 전속 0.5% / 비전속 0.7–0.9%, 매입사 1.5–2.0% (체결 시점)
...
const FAQS = [
  ...
  {
    q: "거래 수수료는 언제 청구되나요?",
    a: "본계약 체결 + ESCROW 잔금 정산 시점에만 청구됩니다. NDA · LOI 단계에서는 수수료가 부과되지 않습니다. 매각사는 전속 0.5% / 비전속 0.7–0.9%, 투자그룹은 1.5–2.0% (낙찰가 기준).",
  },
  {
