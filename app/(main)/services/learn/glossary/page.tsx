...
const catColors: Record<string, string> = {
  "기초 용어": "bg-stone-100/10 text-stone-900 border-stone-300/20",
  "법률 용어": "bg-stone-100/10 text-stone-900 border-stone-300/20",
  "금융 용어": "bg-stone-100/10 text-stone-900 border-stone-300/20",
  "경매 절차": "bg-stone-100/10 text-stone-900 border-stone-300/20",
  "채권 관련": "bg-stone-100/10 text-stone-900 border-stone-300/20",
};
