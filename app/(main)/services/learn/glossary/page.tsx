...
const catColors: Record<string, string> = {
  "기초 용어": "bg-blue-500/10 text-blue-400 border-blue-500/20",
  "법률 용어": "bg-purple-500/10 text-purple-400 border-purple-500/20",
  "금융 용어": "bg-emerald-500/10 text-emerald-400 border-emerald-500/20",
  "경매 절차": "bg-amber-500/10 text-amber-400 border-amber-500/20",
  "채권 관련": "bg-rose-500/10 text-rose-400 border-rose-500/20",
};
