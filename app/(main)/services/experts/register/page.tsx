          ...
          {step === 1 && (
            <>
              ...
              <div>
                ...
                <label className={`flex flex-col items-center justify-center gap-2 border-2 border-dashed border-[var(--color-border-default)] rounded-xl p-8 cursor-pointer hover:border-[var(--color-brand-mid)] hover:bg-blue-50/30 transition-colors`}>
          ...
          {step === 3 && (
            <>
              ...
              <div>
                ...
                <label className={`flex flex-col items-center justify-center gap-2 border-2 border-dashed border-[var(--color-border-default)] rounded-xl p-6 cursor-pointer hover:border-[var(--color-brand-mid)] hover:bg-blue-50/30 transition-colors`}>
