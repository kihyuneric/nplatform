 ...
 *   - /deals/dealroom/chat   (full-page 채팅 — 좌: 매입사 리스트 / 우: 채팅)
 *
 * 자동 기록 룰셋 (RULE_SET):
...
export const INITIAL_BUYER_THREADS: BuyerThread[] = [
  {
    ...
    messages: [
      ...
      { id: 1, type: "system", author: "NPLatform · 시스템", time: "10/24 09:02", text: "[자동 기록 · R2] NDA 전자서명 체결 완료. 매각사 권리증·등기부를 열람할 수 있습니다." },
      { id: 2, type: "seller", author: "○○은행 김 팀장", role: "매각사", time: "09:14", text: "안녕하세요, 권리분석서 첨부드립니다.", attachment: "권리분석서_0412.pdf" },
      { id: 3, type: "buyer", author: "○○대부업체 박 팀장", role: "매입사", time: "10:21", text: "감사합니다. 검토 후 회신드리겠습니다." },
      { id: 4, type: "buyer", author: "○○대부업체 박 팀장", role: "매입사", time: "14:08", text: "초기 검토 완료. 7.8억 (할인율 35%) 1차 오퍼 제출드립니다." },
      { id: 5, type: "seller", author: "○○은행 김 팀장", role: "매각사", time: "10/25 09:02", text: "할인율이 다소 큽니다. 8.7억 (27.5%) 으로 역제안드립니다." },
      { id: 6, type: "buyer", author: "○○대부업체 박 팀장", role: "매입사", time: "오늘 10:21", text: "매각희망가 8.5억 기준 LOI 제출 검토 중입니다. 에스크로 일정 조율 가능할까요?" },
      { id: 102, type: "system", author: "NPLatform · 시스템", time: "오늘 10:30", text: "[자동 기록 · R3] LOI 제출됨 → 매각사 승인 대기 중." },
      { id: 7, type: "seller", author: "○○은행 김 팀장", role: "매각사", time: "오늘 10:35", text: "이번 주 금요일까지 LOI 접수 가능. 에스크로 KB 기준 D+3 예정." },
    ],
  },
  {
    id: "th-002",
    ...
    messages: [
      ...
      { id: 2, type: "seller", author: "○○은행 김 팀장", role: "매각사", time: "10/26 14:20", text: "관심 가져주셔서 감사합니다. 감정평가서·등기부 원본 공유드립니다.", attachment: "감정평가서_0426.pdf" },
      { id: 3, type: "buyer", author: "○○자산운용 이 매니저", role: "매입사", time: "오늘 09:42", text: "감정평가서 검토 중. 주말 내 1차 오퍼 회신드리겠습니다." },
    ],
  },
  {
    id: "th-003",
    ...
    messages: [
      ...
      { id: 2, type: "buyer", author: "○○투자증권 정 차장", role: "매입사", time: "10/20 11:15", text: "기본 자료 확인 완료. 내부 검토 진행하겠습니다." },
      { id: 3, type: "seller", author: "○○은행 김 팀장", role: "매각사", time: "10/21 09:00", text: "추가 자료 필요 시 언제든 요청 주세요." },
      { id: 302, type: "system", author: "NPLatform · 시스템", time: "10/22 14:20", text: "[자동 기록 · P1] 매입사 메시지 1건에서 전화번호 패턴 감지 → 자동 마스킹 처리됨." },
      { id: 4, type: "buyer", author: "○○투자증권 정 차장", role: "매입사", time: "10/22 16:08", text: "내부 위원회 결과 대기 중. 회신 지연 양해바랍니다." },
    ],
  },
]
