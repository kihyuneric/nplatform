      ...
      <div className="border-b border-[var(--color-border-subtle)] bg-[var(--color-surface-elevated)]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10">
          ...
          <div className="flex gap-2 mt-4">
            <span className={`${DS.text.label} bg-emerald-50 text-emerald-700 border border-emerald-200 rounded-full px-3 py-1`}>정보통신망법 준수</span>
            <span className={`${DS.text.label} bg-blue-50 text-blue-700 border border-blue-200 rounded-full px-3 py-1`}>개인정보보호법 준수</span>
          </div>
        </div>
      </div>
        ...
        <div className="flex gap-10">
          ...
          <div className="flex-1 min-w-0 max-w-3xl">
            ...
            <div className="bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r-lg mb-8">
              <p className={`${DS.text.bodyBold} text-amber-800`}>변경 안내 (2026.03.01 시행)</p>
              <p className={`${DS.text.caption} text-amber-700 mt-1`}>주요 변경: AI 분석 데이터 처리 항목 추가, 쿠키 정책 세분화.</p>
            </div>
            ...
            <div className="space-y-10">
              ...
              <Section id="section-9" title="9. 안전성 확보 조치">
                <div className="bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r-lg mb-3">
                  <p className={`${DS.text.bodyBold} text-amber-800`}>AES-256 암호화 및 SSL/TLS 적용으로 개인정보를 안전하게 보호합니다.</p>
                </div>
              ...
              <Section id="section-11" title="11. 고지의 의무">
                ...
                <div className="rounded-xl border border-blue-200 bg-blue-50/50 p-4 space-y-1">
                  <p className={`${DS.text.bodyBold} text-blue-800 mb-1`}>개정 이력</p>
                  <p className={`${DS.text.caption} text-blue-700`}>2026.03.01 — v2.0: AI 분석 항목 추가, 쿠키 정책 세분화</p>
                  <p className={`${DS.text.caption} text-blue-700`}>2026.01.01 — v1.1: 처리위탁 업체 목록 갱신</p>
                  <p className={`${DS.text.caption} text-blue-700`}>2025.01.01 — v1.0: 최초 제정</p>
                </div>
              </Section>
