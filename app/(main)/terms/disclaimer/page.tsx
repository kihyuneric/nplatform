        ...
        <div className="flex gap-10">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r-xl mb-8">
              <p className={`${DS.text.bodyBold} text-amber-800 mb-1`}>투자 위험 고지</p>
              <p className={`${DS.text.body} text-amber-700`}>
            ...
            <div className="space-y-6 max-w-3xl">
              ...
              {/* General notices */}
              <div className="bg-blue-50 border-l-4 border-[var(--color-brand-mid)] p-4 rounded-r-xl">
                <h2 className={`${DS.text.cardSubtitle} text-blue-800 mb-3`}>일반 고지 사항</h2>
                <ul className="space-y-2">
                  {[
                    ...
                    <li key={i} className={`flex items-start gap-2 ${DS.text.body} text-blue-800`}>
