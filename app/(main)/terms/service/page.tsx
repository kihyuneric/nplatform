              ...
              {[
                ...
                { id: "section-8", title: "제8조 (금지행위)", content: <>
                  <div className="bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r-lg mb-4">
                    <p className={`${DS.text.label} text-amber-800 mb-1`}>중요 조항</p>
                    <p className={`${DS.text.body} text-amber-700`}>다음 행위 위반 시 서비스 이용이 즉시 제한될 수 있으며, 법적 책임이 발생할 수 있습니다.</p>
                  </div>
                ...
                { id: "section-10", title: "제10조 (면책조항)", content: <>
                  <div className="bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r-lg mb-4">
                    <p className={`${DS.text.label} text-amber-800 mb-1`}>투자 위험 고지</p>
                    <p className={`${DS.text.body} text-amber-700`}>서비스에서 제공되는 모든 분석 및 통계 데이터는 참고용이며, 투자 판단의 최종 책임은 이용자에게 있습니다.</p>
                  </div>
