  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4">
      ...
      <div className="flex gap-3">
        <button onClick={reset} className="px-4 py-2 rounded-md border border-[var(--color-border-subtle)] text-sm font-medium text-[var(--color-text-primary)] hover:bg-[var(--color-surface-overlay)]">다시 시도</button>
