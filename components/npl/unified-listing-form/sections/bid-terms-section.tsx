      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div>
          <label className="block text-[0.6875rem] font-semibold text-[var(--color-text-secondary)] mb-1">
            최저 입찰가 <span className="text-red-500">*</span>
          </label>
          <div className="relative">
            <input
              ...
              className="w-full rounded-lg bg-[var(--color-surface-base)] border border-[var(--color-border-subtle)] px-3 py-2 pr-8 text-[0.8125rem] tabular-nums focus:border-amber-500/60 focus:outline-none"
            />
        ...
        <div>
          <label className="block text-[0.6875rem] font-semibold text-[var(--color-text-secondary)] mb-1">
            입찰 종료일 <span className="text-red-500">*</span>
          </label>
          <input
            type="date"
            value={value.bidEndDate}
            onChange={(e) => onChange({ bidEndDate: e.target.value })}
            className="w-full rounded-lg bg-[var(--color-surface-base)] border border-[var(--color-border-subtle)] px-3 py-2 text-[0.8125rem] focus:border-amber-500/60 focus:outline-none [color-scheme:light] dark:[color-scheme:dark]"
          />
        </div>
        ...
        <div>
          <label className="block text-[0.6875rem] font-semibold text-[var(--color-text-secondary)] mb-1">
            유보 가격 <span className="text-[0.625rem] font-normal text-[var(--color-text-tertiary)]">· 비공개 내부 하한</span>
          </label>
          <div className="relative">
            <input
              type="text"
