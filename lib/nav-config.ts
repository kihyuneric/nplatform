...
export const DEFAULT_NAV_CONFIG: NavConfig = {
  ...
  pageSubNavs: {
    exchange: [
      { key: 'ex_all',          label: '전체 매물',  href: '/exchange',                description: 'NPL 전체 매물 목록',        icon: 'List',         active: true, order: 1 },
      { key: 'ex_search',       label: 'NPL 검색',   href: '/exchange/search',          description: '상세 필터 데이터 그리드',    icon: 'Search',       active: true, order: 2 },
      { key: 'ex_map',          label: 'NPL 지도',   href: '/exchange/map',             description: '지도 기반 탐색',            icon: 'Map',          active: true, order: 3 },
      { key: 'ex_bidding',      label: 'NPL 입찰',   href: '/exchange/auction',         description: '입찰 참여',                 icon: 'Gavel',        active: true, order: 4 },
      ...
      { key: 'ex_fund',         label: '펀드',       href: '/exchange/fund',            description: 'NPL 펀드 투자',             icon: 'PiggyBank',    active: true, order: 9 },
    ...
    analysis: [
      ...
      { key: 'analysis_copilot', label: 'AI Copilot',      href: '/analysis/copilot',            description: 'AI 투자 조언 챗봇',        icon: 'Sparkles',    active: true, order: 4 },
      { key: 'analysis_sim',     label: '경매 시뮬레이터', href: '/analysis/simulator',          description: '수익률 시뮬레이션',        icon: 'Calculator',  active: true, order: 5 },
      { key: 'analysis_ocr',     label: 'OCR 문서인식',    href: '/analysis/ocr',                description: '문서 자동 데이터 추출',    icon: 'ScanLine',    active: true, order: 6 },
      { key: 'analysis_due',     label: '실사 리포트',     href: '/analysis/due-diligence',      description: '실사 보고서 작성',         icon: 'FileText',    active: true, order: 7 },
    ],
    services: [
  ...
  categories: [
    {
      ...
      order: 1,
      items: [
        { key: 'exchange_browse', label: '전체 매물', href: '/exchange', description: 'NPL 매물 검색 및 탐색', icon: 'Search', active: true, order: 1 },
        ...
        { key: 'exchange_fund', label: '펀드 매물', href: '/exchange/fund', description: 'NPL 펀드 투자', icon: 'PiggyBank', active: true, order: 5 },
    ...
    },
    {
      ...
      items: [
        ...
        { key: 'analysis_new',       label: 'NPL 분석',        href: '/analysis/new',        description: 'AI 채권 가치 분석',       icon: 'FileSearch', active: true, order: 2 },
        { key: 'analysis_nbi',       label: 'NPL 가격지수',    href: '/analysis/npl-index',  description: 'NBI 주간 낙찰가율 지수',  icon: 'TrendingUp', active: true, order: 3 },
        { key: 'analysis_simulator', label: '경매 시뮬레이터', href: '/analysis/simulator',  description: '수익률 시뮬레이션',       icon: 'Calculator', active: true, order: 4 },
        { key: 'analysis_ocr',       label: 'OCR 문서인식',    href: '/analysis/ocr',        description: '문서 자동 데이터 추출',   icon: 'ScanLine',   active: true, order: 5 },
      ],
    },
    {
      key: 'services',
    ...
    },
    {
      ...
      order: 5,
      items: [
        { key: 'tool_simulator', label: '수익률 계산기', href: '/analysis/simulator', description: '경매 수익률 분석', icon: 'Calculator', active: true, order: 1 },
        { key: 'tool_ocr', label: 'OCR 인식', href: '/analysis/ocr', description: '문서 자동 인식', icon: 'ScanLine', active: true, order: 2 },
