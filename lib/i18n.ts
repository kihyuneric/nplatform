...
// ── Phase L · P1 Tier S · 인증 (login / signup) ──────────────────
Object.assign(STATIC_DICT.en, {
  // 로그인 페이지
  '다시 만나서': 'Welcome back,',
  '반갑습니다': 'glad to see you again',
  'NPL 투자의 미래가 여기 있습니다': 'The future of NPL investing is here',
  'NPLatform에 오신 것을 환영합니다': 'Welcome to NPLatform',
  ...
  '또는 이메일로 로그인': 'Or log in with email',
  '이메일 또는 아이디': 'Email or username',
  '비밀번호를 입력하세요': 'Enter your password',
  '아이디 저장': 'Remember me',
  '비밀번호 찾기': 'Forgot password?',
  '로그인 중...': 'Logging in…',
  '🔓 개발용 테스트 계정': '🔓 Dev test accounts',
  '관리자': 'Admin',
  '데모 사용자': 'Demo user',
  '매도자 데모': 'Seller demo',
  '가입자': 'Members',
  ...
  '파트너': 'Partner',
  '기관': 'Institution',
  '매물 탐색 및 입찰': 'Browse and bid on listings',
  '매물 등록 및 매각': 'List and sell properties',
  '법률·세무·감정 자문': 'Legal · tax · appraisal advisory',
  '딜 소싱 및 연결': 'Deal sourcing and matching',
  '대부업체 매입': 'Money-lender purchase',
  '매수자 혜택': 'Buyer benefits',
  '매도자 혜택': 'Seller benefits',
  '전문가 혜택': 'Expert benefits',
  '파트너 혜택': 'Partner benefits',
  '대부업체 혜택': 'Money-lender benefits',
  '사업자등록증': 'Business registration',
  '신분증 사본': 'ID copy',
  '금융기관 인가증': 'Financial institution license',
  '담당자 명함': 'Contact business card',
  '명함': 'Business card',
  '자격증 사본': 'Certification copy',
  '전국 NPL 매물 실시간 열람': 'Real-time access to nationwide NPL listings',
  'AI 기반 수익성 분석 리포트': 'AI-driven profitability analysis report',
  '입찰 전략 자동 시뮬레이션': 'Automated bidding-strategy simulation',
  '매물 즉시 등록 및 노출': 'Instant listing and exposure',
  '검증된 매수자 네트워크 접근': 'Access to verified buyer network',
  '딜클로징 전문가 지원': 'Deal-closing expert support',
  // 매물 등록 위자드 step
  '상세 · 권리': 'Details · Rights',
})

// ── Phase L · P3 · 빈도순 상위 미등록 텍스트 일괄 등록 (extract-i18n-keys.mjs 결과 기반) ──
Object.assign(STATIC_DICT.en, {
  // 인증 / 권한
  ...
  '우리은행': 'Woori Bank',
  '하나은행': 'Hana Bank',
  '한국자산관리공사': 'Korea Asset Management Corp',
  // UI
  '액션': 'Action',
  '제목': 'Title',
  '이메일': 'Email',
...
Object.assign(STATIC_DICT.ja, {
  // 로그인 페이지
  '다시 만나서': 'おかえりなさい、',
  '반갑습니다': 'またお会いできてうれしいです',
  'NPL 투자의 미래가 여기 있습니다': 'NPL投資の未来がここにあります',
  'NPLatform에 오신 것을 환영합니다': 'NPLatformへようこそ',
  '계정이 없으신가요?': 'アカウントをお持ちでないですか？',
  '무료 가입': '無料登録',
  '카카오로 계속하기': 'カカオで続ける',
  'Google로 계속하기': 'Googleで続ける',
  '네이버로 계속하기': 'NAVERで続ける',
  '또는 이메일로 로그인': 'またはメールでログイン',
  '이메일 또는 아이디': 'メールまたはID',
  '비밀번호를 입력하세요': 'パスワードを入力してください',
  '아이디 저장': 'IDを保存',
  '비밀번호 찾기': 'パスワードをお忘れですか？',
  '로그인 중...': 'ログイン中...',
  '🔓 개발용 테스트 계정': '🔓 開発用テストアカウント',
  '관리자': '管理者',
  '데모 사용자': 'デモユーザー',
  '매도자 데모': '売却者デモ',
  '가입자': '登録者',
  ...
  '매물 탐색 및 입찰': '物件閲覧・入札',
  '매물 등록 및 매각': '物件登録・売却',
  '법률·세무·감정 자문': '法務・税務・鑑定アドバイザリー',
  '딜 소싱 및 연결': 'ディールソーシング・マッチング',
  '대부업체 매입': '貸金業者買収',
  '매수자 혜택': 'バイヤー特典',
  '매도자 혜택': 'セラー特典',
  '전문가 혜택': '専門家特典',
  ...
  '명함': '名刺',
  '자격증 사본': '資格証写し',
  '전국 NPL 매물 실시간 열람': '全国NPL物件のリアルタイム閲覧',
  'AI 기반 수익성 분석 리포트': 'AIベース収益分析レポート',
  '입찰 전략 자동 시뮬레이션': '入札戦略の自動シミュレーション',
  '매물 즉시 등록 및 노출': '物件の即時登録・公開',
  '검증된 매수자 네트워크 접근': '検証済みバイヤーネットワークへのアクセス',
  '딜클로징 전문가 지원': 'ディールクロージング専門家サポート',
  // 매물 등록 위자드 step
  '상세 · 권리': '詳細・権利',
})
