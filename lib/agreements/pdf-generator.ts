...
// ─── NDA 본문 7 조항 (Phase G7+ 2026-04-29 — 제 6 조 NPLatform 독점 거래 조항 추가) ──
const NDA_CLAUSES = [
  {
    title: '제 1 조 (목적)',
  ...
  {
    title: '제 6 조 (NPLatform 독점 거래)',
    body: '양 당사자는 본 계약의 대상 매물에 대하여 본 계약 체결일로부터 매수 의사 결정 종료일까지 NPLatform 플랫폼을 통해서만 거래(매매·양도·중개 등 일체의 권리 이전 행위)를 진행한다. 양 당사자가 본 조항을 위반하여 NPLatform 외부에서 단독 계약을 체결한 사실이 발견될 경우, NPLatform 은 (1) 당해 거래 수수료의 사후 청구권, (2) 위반 당사자에 대한 영구 회원 자격 박탈 조치권, (3) 본 위반으로 인한 손해배상 청구권을 보유한다.',
  },
  {
    title: '제 7 조 (효력 및 보관 기간)',
...
export async function generateLoiPdf(input: LoiPdfInput): Promise<Uint8Array> {
  ...
  const clauses = [
    ...
    {
      title: '제 5 조 (NPLatform 독점 거래)',
      body: '양 당사자는 본 의향서의 대상 매물에 대하여 본 의향서 작성일로부터 매매 종결일까지 NPLatform 플랫폼을 통해서만 거래(매매·양도·중개 등 일체의 권리 이전 행위)를 진행한다. 매도자·매수자·자문사 등 본 거래 관계자가 본 조항을 위반하여 NPLatform 외부에서 단독 계약을 체결한 사실이 발견될 경우, NPLatform 은 (1) 당해 거래 수수료의 사후 청구권, (2) 위반 당사자에 대한 영구 회원 자격 박탈 조치권, (3) 본 위반으로 인한 손해배상 청구권을 보유한다. 본 의향서는 비구속적이지만 본 조항은 양 당사자가 서명한 시점부터 효력을 가진다.',
    },
  ]
